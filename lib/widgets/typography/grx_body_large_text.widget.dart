...
///
/// Sets [GrxBodyLargeTextStyle] as [style] default value.
class GrxBodyLargeText extends StatelessWidget {
  ...
  GrxBodyLargeText.lerp(
    this.text, {
    super.key,
    required final GrxBodyLargeTextStyle style,
