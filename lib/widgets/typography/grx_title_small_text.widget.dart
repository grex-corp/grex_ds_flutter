...
///
/// Sets [GrxTitleSmallTextStyle] as [style] default value.
class GrxTitleSmallText extends StatelessWidget {
  /// Creates a Design System's [Text].
  const GrxTitleSmallText(
    this.text, {
    super.key,
    this.textAlign,
  ...
  GrxTitleSmallText.lerp(
    this.text, {
    super.key,
    required final GrxTitleSmallTextStyle style,
